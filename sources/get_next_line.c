...
/*   Updated: 2024/09/24 17:32:33 by dzubkova         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/get_next_line.h"

static char	*concatenate(t_list *parts);
static char	*copy_string_idx(char *buffer, int start, int end);
static int	append_part(char *buffer, int *position, t_list **parts);
static int	parse_buffer(int *position, char *buffer, t_list **parts, int fd);
